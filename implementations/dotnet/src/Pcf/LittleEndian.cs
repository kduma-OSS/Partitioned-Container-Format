...
/// <summary>
/// Explicit little-endian integer helpers. The PCF spec mandates little-endian
/// for every multi-byte integer (section 2.3); reading and writing the bytes
/// by hand keeps the encoding independent of the host's native byte order.
/// </summary>
